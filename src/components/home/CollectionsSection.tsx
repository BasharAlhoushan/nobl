    ...
    <section className="py-24 sm:py-32 bg-nubl-obsidian text-nubl-ivory">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-6 border-b border-nubl-border/40">
          <div>
            <span className="text-xs uppercase tracking-luxury text-nubl-gold block mb-2 font-medium">
              التشكيلات الحصرية
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-wide text-nubl-ivory">
              مجموعات نُـبْـل
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <motion.div
            ...
            className="lg:col-span-7 relative group min-h-[440px] sm:min-h-[560px] overflow-hidden bg-black shadow-lg"
          >
            <img
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 sm:p-12 flex flex-col justify-end">
              <span className="text-xs uppercase tracking-widest text-[#E8D8B5] mb-2 block font-medium">
                01 / كسر العود المعتق
              </span>
              <h3 className="text-3xl sm:text-4xl font-light text-white mb-2">
                {incenseCat.name}
              </h3>
              <p className="text-sm text-white/85 font-light max-w-md mb-6 leading-relaxed">
                &ldquo;{incenseCat.tagline}&rdquo;
              </p>
              <div>
                <Link
                  to={`/category/${incenseCat.slug}`}
                  className="inline-flex items-center gap-3 px-6 py-3 bg-nubl-gold text-[#0B0A09] text-xs font-semibold tracking-wider hover:bg-nubl-goldHover transition-colors group/btn shadow-md"
                >
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <motion.div
              ...
              className="relative group min-h-[260px] sm:min-h-[270px] overflow-hidden bg-black shadow-md flex-1"
            >
              <img
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8 flex flex-col justify-end">
                <span className="text-[11px] uppercase tracking-widest text-[#E8D8B5] mb-1 block font-medium">
                ...
                <div>
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-xs font-medium text-nubl-gold hover:text-white transition-colors"
                  >
          ...
          <motion.div
            ...
            className="lg:col-span-12 relative group min-h-[300px] sm:min-h-[360px] overflow-hidden bg-black mt-2 shadow-lg"
          >
            <img
              src={giftsCat.image}
              alt={giftsCat.name}
            ...
            <div className="absolute inset-y-0 right-0 p-8 sm:p-14 flex flex-col justify-center max-w-xl">
              ...
              <div>
                <Link
                  ...
                  className="inline-flex items-center gap-3 px-6 py-3 bg-nubl-gold text-[#0B0A09] text-xs font-semibold tracking-wider hover:bg-nubl-goldHover transition-colors shadow-md"
                >
